...
export const dataQualityQueryKeys = {
    ...
    detail: (filingId: string, datasetVersion: string, ruleSetVersion: string, validationResultId: string) => ['data-quality', 'result', filingId, datasetVersion, ruleSetVersion, validationResultId] as const,
};
